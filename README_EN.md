...
Install with `npx skills add YZDame/headteacher-skill --list`, or install the Codex Plugin bundle. The canonical data contract is documented in `references/data-contract.md`; Feishu is the first live-tested backend, while Notion and Obsidian adapters ship with mappings and fixtures.
